...
class QFastMain(QWidget):
    ...
    def initUI(self):
        ...
        # Buton Listesi ve Sıralaması (Invert kaldırıldı, OCR eklendi)
        tools = [
            ...
            ("OCR Tool", "ocr.py", "ocr.png"),
            ("Censor", "censor.py", "censor.png"),
            ("EXIF Clean", "removeexif.py", "deleteexif.png"),
            ("Color Picker", "colorpicker.py", "colorpicker.png"),
            ("Format Converter", "converter.py", "format.png"),
            ("Compress GIF", "gifoptimizer.py", "gifoptimizer.png"),
            ("QR Generator", "qrtool.py", "qrtool.png"),
            ("Remove BG", "remover.py", "remover.png"),
            ("Watermark", "watermark.py", "watermark.png")
        ]
    ...
    def show_language_warning(self):
        lang_text = (
            ...
            "很遗憾，目前还不支持动态语言。\n"
            "안타깝게도 henüz 동적 언어 지원을 사용할 수 없습니다."
        )
